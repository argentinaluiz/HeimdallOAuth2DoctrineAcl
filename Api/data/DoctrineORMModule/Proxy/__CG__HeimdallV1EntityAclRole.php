 ...
 */
class AclRole extends \Heimdall\V1\Entity\AclRole implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Heimdall\\V1\\Entity\\AclRole' . "\0" . 'id', '' . "\0" . 'Heimdall\\V1\\Entity\\AclRole' . "\0" . 'roleId', '' . "\0" . 'Heimdall\\V1\\Entity\\AclRole' . "\0" . 'parent'];
        }
